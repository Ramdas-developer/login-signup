...
//     <input type="number" onChange={handleInputChange} value={formData.phone} name="phone" class="form-control" id="exampleInputPhone" aria-describedby="phoneHelp" placeholder="Enter phone" />
//     <small id="emailHelp" class="form-text text-muted"></small>
//   </div>
